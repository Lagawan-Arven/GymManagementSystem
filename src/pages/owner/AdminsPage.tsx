        ...
        <main className="flex flex-col md:flex-row gap-3 md:gap-2 pt-2">
          ...
          <section className="md:w-[40vw]">
            ...
            <div className="h-[20vh] md:h-[75vh] w-full px-2 py-2 md:px-5 rounded-xl bg-neutral-300 dark:bg-neutral-800">
              {adminList && (
                <div className="h-[10vh] md:h-[45vh] flex flex-col gap-2 overflow-auto">
          ...
          <section className="md:flex-1">
            {/*----------- Admin Details ---------- */}
            {!showAdminForm && (
              <div className="h-[50vh] md:h-[75vh] w-full py-2 px-2 space-y-5 md:gap-y-10 content-center md:px-5 rounded-xl bg-neutral-300 dark:bg-neutral-800">
                {/* Header */}
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[16px] md:text-[18px] lg:text-[20px]">
                    ID:{" "}
                    {selectedAdmin && (
                      <span className="font-mono">{selectedAdmin.id}</span>
                    )}
                  </p>
                  {/* Name*/}
                  <p className="text-[16px] md:text-[18px] lg:text-[20px]">
                    Name:{" "}
                    {selectedAdmin && (
                      <span className="font-mono">{selectedAdmin.name}</span>
                    )}
                  </p>
                  {/* Username*/}
                  <p className="text-[16px] md:text-[18px] lg:text-[20px]">
                  ...
                  <p className="text-[16px] md:text-[18px] lg:text-[20px]">
                    Email:{" "}
                    {selectedAdmin && (
                      <span className="font-mono">{selectedAdmin.email}</span>
                    )}
                  </p>
                  {/* Added_at*/}
                ...
                <div className="flex flex-col gap-2 md:gap-5">
                  ...
                  <div className="flex justify-around">
                    ...
                    <Card
                      label="Member Added"
                      text="Total: "
                      value={selectedAdmin ? selectedAdmin.members.length : 0}
                      icon={TbSum}
                    />
                  ...
                  <div className="flex justify-around">
                    ...
                    <Card
                      ...
                      text="Total: "
                      value={selectedAdmin ? selectedAdmin.sessions.length : 0}
                      icon={TbSum}
                    />
                    {/* Member*/}
                    <Card
              ...
              <div className="relative h-[50vh] md:h-[75vh] w-full py-2 px-2 space-y-5 md:space-y-10 md:px-5 md:content-center rounded-xl bg-neutral-300 dark:bg-neutral-800">
                ...
                >
                  ...
                  <input
                    ...
                    value={adminForm.email ? adminForm.email : undefined}
                    onChange={(e) =>
