...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    const getMembers = async () => {
      try {
        ...
        setMonthlyMembers(month);
        setWeeklyMembers(week);
        setAllMembers(all);
      } catch (error) {
  ...
  const thisWeekData = [
    { day: "Mon", session: 50, member: 40, single: 10, new_member: 5 },
    { day: "Tue", session: 45, member: 35, single: 10, new_member: 2 },
    { day: "Wed", session: 50, member: 40, single: 10, new_member: 4 },
    { day: "Thu", session: 45, member: 35, single: 10, new_member: 2 },
    { day: "Fri", session: 50, member: 40, single: 10, new_member: 5 },
    { day: "Sat", session: 35, member: 25, single: 10, new_member: 3 },
    { day: "Sun", session: 30, member: 25, single: 5, new_member: 5 },
  ];
        ...
        <main className="flex flex-col md:flex-row gap-2 pt-2">
          ...
          <div className="grid gap-2 md:flex-1">
            ...
            <section className="rounded-xl bg-neutral-300 dark:bg-neutral-800">
              <LineCard
                label="Today"
                sessions={todaySessions ? todaySessions.length : 100}
                member={
                  todaySessions
                ...
                new_member={todayMembers ? todayMembers.length : 100}
              />
            </section>
              ...
              <div className="grid gap-2 ">
                ...
                <div className="flex gap-2 text-center">
                  ...
                  <Card
                    ...
                    value={
                      allMembers
                        ? allMembers.filter((member) => member.isActive).length
                        : 100
                    }
